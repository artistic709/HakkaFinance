...
contract LPTokenWrapper {
    ...
    IERC20 public TYT = IERC20(0x7F8093f5F49a9D7F0334f8017fF777F1893032d5); // ThankYouToken
    ...
    function stake(uint256 amount) public {
        ...
        TYT.safeTransferFrom(msg.sender, address(this), amount);
    }
    ...
    function withdraw(uint256 amount) public {
        ...
        TYT.safeTransfer(msg.sender, amount);
    }
}
...
contract HakkaRewardsVesting is LPTokenWrapper, IRewardDistributionRecipient {
    ...
    function inCaseTokenGetsStuckPartial(IERC20 _TokenAddress, uint256 _amount) onlyOwner public {
        require(_TokenAddress != hakka && _TokenAddress != TYT);
